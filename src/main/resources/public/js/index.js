...
createTxt('¿Que libro estas buscando?', searchLbl, 'search-text');
...
function searchclick(texto){
  console.log(texto)
  var searchTxtt = document.getElementById('input').value;
  var searchTxt3 = "https://api.mercadolibre.com/sites/MLA/search?nickname=IGNACIO%20CECCHINI&q=".concat(document.getElementById('input').value);
  window.open (searchTxt3);
  console.log(searchTxt2)
  console.log(searchTxt3);
